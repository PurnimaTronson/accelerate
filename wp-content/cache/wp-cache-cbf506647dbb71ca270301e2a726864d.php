...
</div><div style="display: none;"><input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></div><input type="hidden" name="_mc4wp_timestamp" value="1493493056" /><input type="hidden" name="_mc4wp_form_id" value="160" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /></div><div class="mc4wp-response"></div></form><!-- / MailChimp for WordPress Plugin --></aside>
...
<![endif]-->
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-logout"><a class="ab-item" href="http://localhost:8888/accelerate/wp-login.php?action=logout&#038;_wpnonce=dead807233">Log Out</a>		</li></ul></div>		</li></ul>			</div>
						<a class="screen-reader-shortcut" href="http://localhost:8888/accelerate/wp-login.php?action=logout&#038;_wpnonce=dead807233">Log Out</a>
					</div>

		</body>
</html>
<!-- Dynamic page generated in 0.562 seconds. -->
<!-- Cached page generated by WP-Super-Cache on 2017-04-29 19:10:56 -->
