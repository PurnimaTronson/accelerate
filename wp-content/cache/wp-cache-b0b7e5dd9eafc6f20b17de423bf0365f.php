...
</script><!-- MailChimp for WordPress v4.1.0 - https://wordpress.org/plugins/mailchimp-for-wp/ --><form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-160" method="post" data-id="160" data-name="Subscribe to Our Newsletter" ><div class="mc4wp-form-fields"><div>
...
</div><div style="display: none;"><input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></div><input type="hidden" name="_mc4wp_timestamp" value="1492059440" /><input type="hidden" name="_mc4wp_form_id" value="160" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /></div><div class="mc4wp-response"></div></form><!-- / MailChimp for WordPress Plugin --></aside>
...
<script type='text/javascript' src='http://localhost:8888/accelerate/wp-content/plugins/mailchimp-for-wp/assets/js/forms-api.min.js?ver=4.1.0'></script>
<!--[if lte IE 9]>
<script type='text/javascript' src='http://localhost:8888/accelerate/wp-content/plugins/mailchimp-for-wp/assets/js/third-party/placeholders.min.js?ver=4.1.0'></script>
<![endif]-->
	<!--[if lte IE 8]>
		<script type="text/javascript">
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-updates"><a class="ab-item" href="http://localhost:8888/accelerate/wp-admin/update-core.php" title="2 Plugin Updates"><span class="ab-icon"></span><span class="ab-label">2</span><span class="screen-reader-text">2 Plugin Updates</span></a>		</li>
		...
		<li id="wp-admin-bar-logout"><a class="ab-item" href="http://localhost:8888/accelerate/wp-login.php?action=logout&#038;_wpnonce=58ab25d8ff">Log Out</a>		</li></ul></div>		</li></ul>			</div>
						<a class="screen-reader-shortcut" href="http://localhost:8888/accelerate/wp-login.php?action=logout&#038;_wpnonce=58ab25d8ff">Log Out</a>
					</div>

		</body>
</html>
<!-- Dynamic page generated in 0.583 seconds. -->
<!-- Cached page generated by WP-Super-Cache on 2017-04-13 04:57:20 -->
